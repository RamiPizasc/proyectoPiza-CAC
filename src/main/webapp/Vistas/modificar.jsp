<%-- 
    Document   : modificar
    Created on : 17 dic. 2021, 23:31:23
    Author     : Ramiro
--%>
...
<html>
    ...
    <body>
        <%
            ...
            Oradores resultado=null;
            OradoresDAO oradoresDao = new OradoresDAO();
            resultado = oradoresDao.mostrarOrador(mid);
        %>
            ...
            <div class="row d-flex justify-content-center">
                <form class="p-5 w-50" action="OradoresController?accion=actualizar" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exposicion" name="exposicion" value="<%=resultado.getExposicion()%>"/>
                    </div>
